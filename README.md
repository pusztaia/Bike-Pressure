...
## Overview
This project provides a single web-based bicycle tire pressure calculator, optimized for mobile use, particularly for iOS devices. It helps cyclists determine optimal tire pressure based on various factors such as bike, wheelset, tire type, rider weight, gear weight, and environmental conditions.
...
## Files
*   `index.html`: The main calculator file, pre-configured for a specific road bike setup:
...
2.  For iPhone users, you can add the page to your home screen for an an app-like experience (Safari: Share button -> "Add to Home Screen").
